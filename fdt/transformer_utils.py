...
Code for the encoder of FDT
 ...
 with the following modifications: support global token
...
class TransformerEncoderWithGloablToken(nn.Module):
    default_config = {
        "hidden_dim":512,
        "nhead":8,
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, memory, mask, query_embed, pos_embed=None, bs=1):
        # flatten NxCxHxW to HWxNxC
